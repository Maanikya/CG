...
float moonx=0, moony=50, bk2Color1=0, bk2Color2=0, bk2Color3=0, ground=0;
...
void Keyboard(unsigned char key, int x, int y) {
	...
	if(key == '1') {
		...
		moonx=0, moony=50, bk2Color1=0.3, bk2Color2=0.2, bk2Color3=0.1, shd=0.1, bk1=0, bk2=0, ground=0;
		slide = 2;
		//Timer2(0);
		//glutPostRedisplay(); 
	}
...
void EffielTower(){
	...
	glVertex3f(66.8, 43, -3);
	glVertex3f(66.6, 44.7, -3);
	glVertex3f(69.2, 44.7, -3);
	glVertex3f(69, 43, -3);
	glEnd();
	...
	glVertex3f(67.9, 35.5, -3);
	glColor3f(0.9, 0.9, 0.9);
	glVertex3f(67.9, 58.8, -3);
	glEnd();
